...
class StoryList {
  ...
  async addStory(user, newStory) {
    ...
    // STORY IS INSTANCE OF STORY OBJECT
    newStory = new Story(res.data.story);

    /* add stroy to top of the lsit unshift() method 
     can prepend one or more elements to the beginning of an array */
    this.stories.unshift(newStory);
    // ADD TO TOP USERS LIST
...
class User {
  ...
  //PASSES THE STORY ID AND HTTPVERB OF 'POST' TO THE TOGGLE FAV CLASS
  addFavorite(storyId) {
    return this.toggleFavorite(storyId, "POST");
  }

  //PASSES THE STORY ID AND HTTPVERB OF 'DELETE' TO THE TOGGLE FAV CLASS
  ...
  /* POSTING METHOD USEING THE ADD AND REMOVE METHODS TO SUPPLY STROY ID AND HTTP VERB 
    THIS METHOD POSTS OR DELETS FAVORITE STATUS TO A STORY AND CALLS RETRIVE DETAILS TO UPDATE USER FAVORITS LIST */ 
